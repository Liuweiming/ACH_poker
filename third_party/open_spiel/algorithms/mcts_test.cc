...
void MCTSTest_SolveDraw() {
  auto root_and_state = SearchTicTacToeState("x(1,1) o(0,0) x(2,2)");
  auto& root = root_and_state.first;
  auto& state = root_and_state.second;
...
void MCTSTest_SolveLoss() {
  auto root_and_state = auto& root = root_and_state.first;
  auto& state = root_and_state.second;
...
void MCTSTest_SolveWin() {
  auto root_and_state = SearchTicTacToeState("x(0,1) o(2,2)");
  auto& root = root_and_state.first;
  auto& state = root_and_state.second;
