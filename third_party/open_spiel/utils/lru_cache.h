...
struct LRUCacheInfo {
  ...
  LRUCacheInfo() : hits(0), misses(0), size(0), max_size(0) {}
  LRUCacheInfo(int64_t hits, int64_t misses, int size, int max_size)
      : hits(hits), misses(misses), size(size), max_size(max_size) {}
