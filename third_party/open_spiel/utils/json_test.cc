...
void TestValue() {
  ...
  SPIEL_CHECK_EQ(absl::get<Null>(Value(Null())), Null());
  ...
  SPIEL_CHECK_EQ(absl::get<bool>(Value(true)), true);
  ...
  SPIEL_CHECK_EQ(absl::get<int64_t>(Value(1)), 1);
  ...
  SPIEL_CHECK_EQ(absl::get<double>(Value(1.5)), 1.5);
  ...
  SPIEL_CHECK_EQ(absl::get<std::string>(Value("asdf")), "asdf");
  ...
  SPIEL_CHECK_EQ(absl::get<Array>(Value(Array({1, 2, 3}))), Array({1, 2, 3}));
  ...
  SPIEL_CHECK_EQ(Value(Object({{"asdf", 1}, {"bar", 2}})).GetObject(),
                 Object({{"asdf", 1}, {"bar", 2}}));
  SPIEL_CHECK_EQ(absl::get<Object>(Value(Object({{"asdf", 1}, {"bar", 2}}))),
                 Object({{"asdf", 1}, {"bar", 2}}));
}
