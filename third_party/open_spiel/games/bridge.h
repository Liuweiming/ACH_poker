...
constexpr int kNumPartnerships = 2;
constexpr int kNumBidLevels = 7;   // Bids can be from 7 to 13 tricks.
constexpr int kNumOtherCalls = 3;  // Pass, Double, Redouble
constexpr int kNumDenominations = 1 + kNumSuits;  // +1 for no-trump.
constexpr int kNumVulnerabilities = 2;  // Vulnerable or non-vulnerable.
constexpr int kNumBids = kNumBidLevels * kNumDenominations;
constexpr int kNumCalls = kNumBids + kNumOtherCalls;
constexpr int kNumCards = kNumSuits * kNumCardsPerSuit;
constexpr int kNumCardsPerHand = kNumCards / kNumPlayers;
constexpr int kNumTricks = kNumCardsPerHand;
constexpr int kBiddingActionBase = kNumCards;  // First bidding action.
constexpr int kMaxScore = 7600;          // See http://www.rpbridge.net/2y66.htm
constexpr int kNumObservationTypes = 4;  // Bid, lead, declare, defend
...
constexpr int kAuctionTensorSize =
...
constexpr int kMaxAuctionLength =
    kNumBids * (1 + kNumPlayers * 2) + kNumPlayers;
constexpr Player kFirstPlayer = 0;
