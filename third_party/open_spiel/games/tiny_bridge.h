...
constexpr int kNumActions2p = 1 + kNumBids;  // Plus Pass
constexpr int kNumActions4p = 3 + kNumBids;  // Pass, Double, Redouble
enum Call { kPass = 0, k1H, k1S, k1NT, k2H, k2S, k2NT, kDouble, kRedouble };
constexpr int kNumRanks = 4;
constexpr int kNumSuits = 2;
constexpr int kDeckSize = kNumRanks * kNumSuits;
constexpr int kNumSeats = 4;
constexpr int kNumTricks = kDeckSize / kNumSeats;
constexpr int kNumAbstractHands = 12;

// Number of possible private states (hands) for a single player.
constexpr int kNumPrivates = (kDeckSize * (kDeckSize - 1)) / 2;
constexpr std::array<const char*, kNumActions4p> kActionStr{
