...
constexpr int kNumChanceOutcomes = 21;
constexpr int kNumPoints = 24;
constexpr int kNumDiceOutcomes = 6;
constexpr int kNumCheckersPerPlayer = 15;
constexpr int kXPlayerId = 0;
constexpr int kOPlayerId = 1;
constexpr int kPassPos = -1;
...
// to strings.
constexpr int kBarPos = 100;
constexpr int kScorePos = 101;
...
constexpr int kNumDistinctActions = 1352;

// See ObservationTensorShape for details.
constexpr int kBoardEncodingSize = 4 * kNumPoints * kNumPlayers;
constexpr int kStateEncodingSize = 3 * kNumPlayers + kBoardEncodingSize;
constexpr char* kDefaultScoringType = "winloss_scoring";
