...
constexpr int NumDistinctActions() { return 4672; }
...
constexpr std::array<PieceType, 3> kUnderPromotionIndexToType = {
    PieceType::kRook, PieceType::kBishop, PieceType::kKnight};
constexpr std::array<Offset, 3> kUnderPromotionDirectionToOffset = {
    {{0, 1}, {1, 1}, {-1, 1}}};
constexpr int kNumUnderPromotions =
...
constexpr int kNumActionDestinations = 73;
