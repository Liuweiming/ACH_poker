...
constexpr int kNumCardsInSkat = 2;
constexpr int kNumGameTypes = 7;
constexpr int kNumTricks = (kNumCards - kNumCardsInSkat) / kNumPlayers;
constexpr int kBiddingActionBase = kNumCards;  // First bidding action.
constexpr int kNumBiddingActions = kNumGameTypes;
constexpr int kNumActions = kNumCards + kNumBiddingActions;
constexpr char kEmptyCardSymbol[] = "🂠";
