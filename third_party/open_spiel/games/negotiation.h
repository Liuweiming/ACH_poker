...
constexpr bool kDefaultEnableProposals = true;
constexpr bool kDefaultEnableUtterances = true;
constexpr int kDefaultNumSymbols = 5;
constexpr int kDefaultUtteranceDim = 3;
constexpr int kMaxQuantity = 5;
constexpr int kMaxValue = 10;
constexpr int kMaxSteps = 10;
constexpr int kNumPlayers = 2;
constexpr int kDefaultNumItems = 3;
