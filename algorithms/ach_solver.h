...
class ACHSolver {
 public:
  ...
  ACHSolver(const Game& game, std::shared_ptr<VPNetEvaluator> value_0_eval_,
            ...
            bool use_policy_net, bool use_tabular, bool anticipatory,
            double alpha, double eta, double epsilon, bool symmetry,
            std::mt19937* rng, AverageType avg_type = AverageType::kSimple);
